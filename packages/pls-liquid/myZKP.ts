// This file is an almost direct copy of a file in liquidjs-lib, except for the imports.
...
} from "liquidjs-lib/src/confidential.js";
import { type Output, ZERO } from "liquidjs-lib/src/transaction.js";
import { ElementsValue } from "liquidjs-lib/src/value.js";
import { randomBytes } from "liquidjs-lib/src/psetv2/utils.js";
// import type { Slip77Interface } from 'slip77';
type Slip77Interface = any;
import type { RngOpts } from "liquidjs-lib/src/psetv2/interfaces.js";
import type { KeysGenerator, Pset } from "liquidjs-lib/src/psetv2/pset.js";
import type {
	IssuanceBlindingArgs,
	OutputBlindingArgs,
	OwnedInput,
} from "liquidjs-lib/src/psetv2/blinder.js";
import { calculateReissuanceToken } from "liquidjs-lib/src/issuance.js";
